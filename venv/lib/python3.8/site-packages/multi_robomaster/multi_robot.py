...
class MultiRobotBase(object):
    ...
    def number_id_by_sn(self, list2, *args):
        """number id by SN

        :param args: [id, SN] id int, SN str
        :return:
        """
        # print(self._robots_list)  # [<robomaster.robot.Robot object at 0x7f9501f955b0>, <robomaster.robot.Robot object at 0x7f9501f95af0>]
        robots_sn_dict = tool.get_robots_sn(self._robots_list, list2)
        # print(robots_sn_dict)  # {None: <robomaster.robot.Robot object at 0x7fab23eebaf0>}
